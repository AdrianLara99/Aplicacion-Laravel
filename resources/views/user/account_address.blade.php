	...
	<div class="col-md-3">
		<div class="panel shadow">
			...
			<div class="inside">
				...
				<label for="module" class="mtop16">Vereda:</label>
				<div class="input-group">
					<span class="input-group-text" id="basic-addon1">
						<i class="far fa-keyboard"></i>
					</span>
				...
				<label for="city" class="mtop16">Sector:</label>
				<div class="input-group">
					<span class="input-group-text" id="basic-addon1">
						<i class="far fa-keyboard"></i>
					</span>
				...
				<label for="add1" class="mtop16">Barrio / Conjunto :</label>
				<div class="input-group">
					<span class="input-group-text" id="basic-addon1">
						<i class="far fa-keyboard"></i>
					</span>
				...
				<label for="add2" class="mtop16">Calle / Carrera / Bloque:</label>
				<div class="input-group">
					<span class="input-group-text" id="basic-addon1">
						<i class="far fa-keyboard"></i>
					</span>
				...
				<table class="table table-striped">
					<thead>
						<tr>
							...
							<td><strong>Vereda / Sector</strong></td>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<p>
									<strong>Barrio / Conjunto:</strong> {{ kvfj($address->addr_info, 'add1') }}
								</p>
								<p>
									<strong>Calle / Carrera / Bloque:</strong> {{ kvfj($address->addr_info, 'add2') }}
								</p>
								<p>
