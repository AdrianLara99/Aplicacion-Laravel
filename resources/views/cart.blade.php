...
<div class="cart mtop32">
	<div class="container">
		...
		<div class="items mtop32">
			<div class="row">
				<div class="col-md-3">
					{!! Form::open(['url' => '/cart', 'files' => true]) !!}
					{!! Form::hidden('payment_method', null, ['id' => 'field_payment_method_id']) !!}
					{!! Form::file('payment_method_transfer_file', ['id' => 'payment_method_transfer_file', 'accept' => 'image/*', 'style' => 'display: none;']) !!}
					<div class="panel">
						<div class="header">
				...
				<div class="col-md-9">
					...
					<div class="row mtop32" id="payment_method_transfer_info" style="display: none;">
						<div class="col-md-6">
							<div class="panel">
								<div class="header">
									<h2 class="title"><i class="fas fa-shopping-cart"></i> Transferencia o deposito.</h2>
								</div>
								<div class="inside">
									<p>
										{!! Config::get('cms.payment_method_transfer_accounts_bank') !!}
									</p>
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="panel">
								<div class="header">
									<h2 class="title"><i class="fas fa-shopping-cart"></i> Subir comprobante.</h2>
								</div>
								<div class="inside">
									<a href="#" id="payment_method_transfer_select_file" class="file_select">
										<img src="{{ url('/static/images/upload_image.png') }}">
									</a>
