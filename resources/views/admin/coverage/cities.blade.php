...
<li class="breadcrumb-item">
	<a href="{{ url('/admin/coverage/'.$state->id.'/cities') }}"><i class="fas fa-shipping-fast"></i> Destino: {{ $state->name }}</a>
</li>
@endsection
	...
	<div class="row">
		<div class="col-md-3">
			...
			<div class="panel shadow">
				<div class="header">
					<h2 class="title"><i class="fas fa-plus"></i> Agregar lugar para envios</h2>
				</div>
		...
		<div class="col-md-9">
			<div class="panel shadow">
				<div class="header">
					<h2 class="title"><i class="fas fa-shipping-fast"></i> Destino: {{ $state->name }}</h2>
				</div>
