	...
	<div class="row">
		<div class="col-md-3">
			...
			<div class="panel shadow">
				<div class="header">
					<h2 class="title"><i class="fas fa-edit"></i> Editar Ubicacion de envío </h2>
				</div>
		...
		<div class="col-md-3">
			...
			<div class="panel shadow">
				...
				<div class="inside">
					@if($coverage->ctype == "1")
					<p><strong>Tipo:</strong> Ubicacion</p>
					<p><strong>Ubicación / Vereda:</strong> {{ $coverage->getState->name }} </p>
					@endif
