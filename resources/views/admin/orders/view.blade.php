		...
		<div class="row">
			...
			<div class="col-md-3">
				...
				<div class="panel shadow mtop16">
					...
					<div class="inside">
						@if($order->o_type == "0")
							<p style="margin-bottom: 2px;"><strong>Ubicacion:</strong> {{ $order->getUserAddress->getState->name }}</p>
							<p style="margin-bottom: 2px;"><strong>Vereda:</strong> {{ $order->getUserAddress->getCity->name }}</p>
			...
			<div class="col-md-3">
				...
				<div class="panel shadow mtop16">
					<div class="header">
						<h2 class="title"><i class="fas fa-ticket-alt"></i> Comprobante.</h2>
					</div>
					<div class="inside">
