...
class UserController extends Controller
{
    ...
    public function postAcccountAddressAdd(Request $request){
        ...
        $messages = [
            ...
            'state.required' => 'Seleccione un estado / Apartamento',
            'city.required' => 'Seleccione una sector',
            'add1.required' => 'Ingrese el nombre de su barrio, o conjunto residencial',
            'add2.required' => 'Ingrese su Calle / carrera / Bloque',
            'add3.required' => 'Ingres el numero de su casa / Apartamento'
        ];
